...
module.exports = function () {
    ...
    return {
        init: async (dbConfig, dbKey, env) => {
            ...
            let confRes = await pg.__select("SELECT decrypt(config, $1, $2) AS config FROM public.app_config WHERE env=$3 AND is_active=true;", [dbKey, algorithm, env]);
